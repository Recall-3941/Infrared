...
@ModuleInfo(name = "PotionRender" , description = "Vape" ,Chinese = "药水显示 ",category = ModuleCategory.RENDER)
public class PotionRender extends Module {
    ...
    public void renderPotionStatusNew(final int width, final int height) {
            ...
            for (final IPotionEffect effect : HUD.mc.getThePlayer().getActivePotionEffects()) {
                ...
                Fonts.com35.drawString(effect.getDurationString().replaceAll("§.", ""), width - 85.0f, y2 + 6.5f, color);
                this.x -= 30;
        }
    }
}
