    ...
    override fun drawElement(): Border? {
        ...
        if (mc.playerController.isNotCreative) {
            ...
            for (index in 3 downTo 0) {
                ...
                val stack2 = mc2.player.inventory.armorInventory[index] ?: continue
                RenderUtils.drawGradientSidewaysV(x.toDouble(), 0.0,x.toDouble() + 18 ,17.0,colorall,Color(140,140,140,40).rgb)
                Fonts.font25.drawStringWithShadow(((stack2.maxDamage - stack.itemDamage)).toString(),x + 4,20,colorall)
                RenderUtils.drawRect(x.toFloat(),25f,x.toFloat() + 18f,26f,Color(140,140,140,220).rgb)
                RenderUtils.drawRect(x.toFloat(),25f,x.toFloat() + (18f * (stack2.maxDamage - stack.itemDamage) / stack2.maxDamage),26f,colorall)
