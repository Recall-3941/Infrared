...
public class EmptyInputBox extends Gui {
    ...
    private final IFontRenderer cFontRenderer;
    ...
    private  Color color;
    public EmptyInputBox(int componentId, FontRenderer fontrendererObj, int x, int y, int par5Width, int par6Height, Color color, IFontRenderer cFontRenderer) {
        this.id = componentId;
    ...
    public void drawTextBox() {
        if (this.getVisible()) {
            int i = this.isEnabled ? color.getRGB() : this.disabledColor;
            ...
            if (s.length() > 0) {
                ...
                j1 = (int) cFontRenderer.drawString(s1, (float) l, (float) i1, i);
            }
            ...
            if (s.length() > 0 && flag && j < s.length()) {
                j1 = (int) cFontRenderer.drawString(s.substring(j), (float) j1, (float) i1, i);
            }
            ...
            if (flag1) {
                if (flag2) {
                    ...
                    cFontRenderer.drawString("_", (float) k1, (float) i1, i);
                }
            }
