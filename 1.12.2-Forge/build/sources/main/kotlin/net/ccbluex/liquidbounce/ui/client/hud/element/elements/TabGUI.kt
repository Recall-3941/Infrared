...
class TabGUI(x: Double = 5.0, y: Double = 25.0) : Element(x = x, y = y) {
    ...
    private val redValue = IntegerValue("Rectangle Red", 255, 0, 255)
    private val greenValue = IntegerValue("Rectangle Green", 255, 0, 255)
    private val blueValue = IntegerValue("Rectangle Blue", 255, 0, 255)
    private val alphaValue = IntegerValue("Rectangle Alpha", 96, 0, 255)
    private val rectangleRainbow = BoolValue("Rectangle Rainbow", false)
    private val backgroundRedValue = IntegerValue("Background Red", 255, 0, 255)
    private val backgroundGreenValue = IntegerValue("Background Green", 255, 0, 255)
    private val backgroundBlueValue = IntegerValue("Background Blue", 255, 0, 255)
    private val backgroundAlphaValue = IntegerValue("Background Alpha", 0, 0, 255)
    private val borderValue = BoolValue("Border", true)
    private val borderStrength = FloatValue("Border Strength", 2F, 1F, 5F)
    private val borderRedValue = IntegerValue("Border Red", 255, 0, 255)
    private val borderGreenValue = IntegerValue("Border Green", 255, 0, 255)
    private val borderBlueValue = IntegerValue("Border Blue", 255, 0, 255)
    private val borderAlphaValue = IntegerValue("Border Alpha", 91, 0, 255)
     ...
     * TabGUI Tab
     */
    inner class Tab(val tabName: String) {
