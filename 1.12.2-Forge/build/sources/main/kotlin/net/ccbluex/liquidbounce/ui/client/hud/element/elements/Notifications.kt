...
class Notifications(x: Double = 0.0, y: Double = 0.0, scale: Float = 1F,side: Side = Side(Side.Horizontal.RIGHT, Side.Vertical.DOWN)) : Element(x, y, scale, side) {
    ...
    companion object {
        val styleValue = ListValue("Mode", arrayOf("Classic", "FDP", "Modern", "Tenacity",  "Skid", "Tena-Classic", "Astolfo"), "Tenacity")
    }
    ...
    override fun drawElement(): Border? {
        ...
        LiquidBounce.hud.notifications.map { it }.forEachIndexed { index, notify ->
            ...
            if (notify.drawNotification(index, Fonts.font30, backGroundAlphaValue.get(), 0F, this.renderX.toFloat(), this.renderY.toFloat(), scale,contentShadow.get(),titleShadow.get(),motionBlur.get(),whiteText.get(),modeColored.get(), Companion)) {
...
class Notification(
    ...
    fun drawNotification(
        ...
        if (style.equals("Modern")) {
            ...
            Fonts.font30.drawString(title, 6F, 3F, textColor, titleShadow)
        ...
        /* if(style.equals("LiquidBounce")) {
            ...
            Fonts.C12.drawString(Fonts.C12, title + ": " + content, -4F, 3F, textColor, titleShadow)
        ...
        if(style.equals("Tenacity")){
            ...
            val error = MinecraftInstance.classProvider.createResourceLocation("loserline/notifications/icons/tenacity/cross.png")
            val successful = MinecraftInstance.classProvider.createResourceLocation("loserline/notifications/icons/tenacity/tick.png")
            val warn = MinecraftInstance.classProvider.createResourceLocation("loserline/notifications/icons/tenacity/warning.png")
            val info = MinecraftInstance.classProvider.createResourceLocation("loserline/notifications/icons/tenacity/info.png")
        ...
        if(style.equals("Tena-Classic")) {
            ...
            if(type.renderColor == Color(0xFF2F2F)){
                RenderUtils.drawImage(MinecraftInstance.classProvider.createResourceLocation("loserline/notifications/icons/tenacity/cross.png"),3,5,18,18)
            }else if(type.renderColor == Color(0x60E092)){
                RenderUtils.drawImage(MinecraftInstance.classProvider.createResourceLocation("loserline/notifications/icons/tenacity/tick.png"),3,5,18,18)
            } else if(type.renderColor == Color(0xF5FD00)){
                RenderUtils.drawImage(MinecraftInstance.classProvider.createResourceLocation("loserline/notifications/icons/tenacity/warning.png"),3,5,18,18)
            } else {
                RenderUtils.drawImage(MinecraftInstance.classProvider.createResourceLocation("loserline/notifications/icons/tenacity/info.png"),3,5,18,18)
            }
        ...
        if(style.equals("Intellij")) {
            val notifyDir = "loserline/notifications/icons/noti/intellij/"
            val imgSuccess = LiquidBounce.wrapper.classProvider.createResourceLocation("${notifyDir}checkmark.png")
            ...
            if(nTypeError){
                ...
                Fonts.com18.drawString(title, -x + 6, -25F, Color(249,130,108).rgb, true)
            }
            if(nTypeInfo) {
                ...
                Fonts.com18.drawString(title, -x + 6, -25F, Color(119,145,147).rgb, true)
            }
            if(nTypeSuccess){
                ...
                Fonts.com18.drawString(title,-x + 6, -25F, Color(10,142,2).rgb, true)
            }
            if(nTypeWarning){
                ...
                Fonts.com18.drawString(title, -x + 6, -25F, Color(175,163,0).rgb, true)
            }
            ...
            Fonts.com18.drawString(content, -x + 6, -13F, -1, true)
            return false
        }
        return false
    }
