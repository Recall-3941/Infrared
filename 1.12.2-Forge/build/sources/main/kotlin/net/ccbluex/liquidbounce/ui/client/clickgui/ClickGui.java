...
public class ClickGui extends WrappedGuiScreen {
    ...
    private final IResourceLocation hudIcon = classProvider.createResourceLocation("loserline" + "/custom_hud_icon.png");
    ...
    public void drawScreen(int mouseX, int mouseY, float partialTicks) {
        ...
        //防止傻逼偷看云参数
        if(LiquidBounce.INSTANCE.isUsingCloudCfg()){
            mc.displayGuiScreen(null);
            JOptionPane.showConfirmDialog(null,"偷参数的狗我草你妈你妈死了",null, JOptionPane.ERROR_MESSAGE);
        }
