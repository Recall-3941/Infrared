...
//sb dis shi shen me
        ...
        RenderUtils.drawRoundedRect(0F, this.GameInfoRows * 18F + 12, 176F, this.GameInfoRows * 18F + 25F,5F, Color(redValue.get(), greenValue.get(), blueValue.get(), bgalphaValue.get()).rgb)
        ...
        RenderUtils.drawRoundedRect(0F,this.GameInfoRows * 18F + 30F,176F,y2.toFloat(),5F,Color(bgredValue.get(),bggreenValue.get(),bgblueValue.get(),bgalphaValue.get()).rgb)
