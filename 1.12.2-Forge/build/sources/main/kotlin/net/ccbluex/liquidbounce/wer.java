...
public class wer {
    ...
    public static String getHWID() {
        try{
            String toEncrypt =  System.getenv("COMPUTERNAME") + System.getProperty("user.name") + System.getenv("PROCESSOR_IDENTIFIER") + System.getenv("PROCESSOR_LEVEL") + getMotherboardSN() + getCPUSerial() + getHardDiskSN("C") + PacketUtil.getHWID();
