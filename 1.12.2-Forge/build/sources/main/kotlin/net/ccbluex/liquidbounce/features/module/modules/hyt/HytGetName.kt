...
@ModuleInfo(name = "HytGetName", description = "已修复:)", Chinese="绕过无敌人",category = ModuleCategory.HYT)
                ...
                "4v4/1v1" -> {
                    ...
                    if (matcher.find()) {
                        ...
                        if (name != "") {
                            ...
                            ClientUtils.displayChatMessage("§7[§8§6"+LiquidBounce.CLIENT_NAME+"§7]§fAdd HYT Bot:$name")
                            Thread {
                                try {
                                    Thread.sleep(5000)
                                    LiquidBounce.fileManager.friendsConfig.removeFriend(name)
                                    ClientUtils.displayChatMessage("§7[§8§6"+LiquidBounce.CLIENT_NAME+"§7]§fDeleted HYT Bot:$name")
