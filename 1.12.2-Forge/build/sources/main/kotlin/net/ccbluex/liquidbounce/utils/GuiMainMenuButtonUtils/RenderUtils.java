...
//        int scaleFactor = 1;
//        float k = MinecraftInstance.mc.getGameSettings().getGuiScale();
//        if (k == 0) {
//            k = 1000;
//        }
//        while (scaleFactor < k && MinecraftInstance.mc.getDisplayWidth() / (scaleFactor + 1) >= 320
//                && MinecraftInstance.mc.getDisplayHeight() / (scaleFactor + 1) >= 240) {
//            ++scaleFactor;
//        }
//        GL11.glScissor((int) (x * scaleFactor), (int) (MinecraftInstance.mc.getDisplayHeight() - (y + windowHeight2) * scaleFactor),
