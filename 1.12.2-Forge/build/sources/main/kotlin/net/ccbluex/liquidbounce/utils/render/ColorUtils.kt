...
object ColorUtils {
    ...
    val gl = LiquidBounce.moduleManager.getModule(GodLightSync::class.java) as GodLightSync
    fun novoRainbow(
        index: Int,
    ...
    fun GodLight(
        ...
        return VisualUtils.getGradientOffset(Color(gl.r.get(), gl.g.get(), gl.b.get(),1), Color(gl.r2.get(), gl.g2.get(), gl.b2.get(),1), (Math.abs(
            System.currentTimeMillis() / 10140+ (index/1.5)
                .toDouble())/10))
    }
    @JvmStatic
