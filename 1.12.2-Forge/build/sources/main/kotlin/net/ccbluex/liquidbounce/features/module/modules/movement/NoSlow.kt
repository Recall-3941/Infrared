...
//作者：不知道
//跑吃没绕，走可以
@ModuleInfo(name = "NoSlow", description = "Cancel slow effect while you try to using hinder items.", category = ModuleCategory.MOVEMENT, Chinese = "无减速")
class NoSlow : Module() {
    private val modeValue = ListValue("Mode", arrayOf("HytPit", "GrimAC", "Vanilla"), "GrimAC")
    ...
    private val foodPacket = BoolValue("FoodPacket",true)
    private val delayValue = IntegerValue("Delay",3,1,20)
