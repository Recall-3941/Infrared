...
class KeyInfo(
    ...
    fun render() {
        ...
        RenderUtils.drawRoundedRect(0F, 0F, width, height,10F, keyColor)
        //RenderUtils.drawRect(0F, height * 0.9F, width, height, shadowColor)
        (if (hasKeyBind) { Fonts.font40 } else { Fonts.font40 })
            .drawCenteredString(keyName, width * 0.5F, height * 0.9F * 0.5F - (Fonts.font35.fontHeight * 0.5F) + 3F, if (hasKeyBind) { usedColor } else { unusedColor }, false)
    ...
    fun renderTab() {
        ...
        // render modules
        val fontHeight = 10F - Fonts.font40.fontHeight * 0.5F
        var yOffset = (12F + Fonts.font40.fontHeight + 10F) - stroll
        ...
        // 覆盖多出来的部分
        RenderUtils.drawRect(0F, 0F, baseTabWidth.toFloat(), 12F + Fonts.font40.fontHeight + 10F, Color.WHITE.rgb)
        RenderUtils.drawRect(0F, baseTabHeight - 22F - Fonts.font40.fontHeight, baseTabWidth.toFloat(), baseTabHeight.toFloat(), Color.WHITE.rgb)
        RenderUtils.drawShadowWithCustomAlpha(0F, 0F, baseTabWidth.toFloat(), baseTabHeight.toFloat(), 200F)
        Fonts.font40.drawString("Bind", 12F, 12F, Color.BLACK.rgb, false)
        Fonts.font40.drawString("Add", baseTabWidth - 12F - Fonts.font40.getStringWidth("Add"), baseTabHeight - 12F - Fonts.font40.fontHeight, Color(0, 191, 255).rgb/*sky blue*/, false)
    ...
    fun click(mouseX: Float, mouseY: Float) {
        ...
        if (keyBindMgr.nowDisplayKey == null) {
            ...
            if (scaledMouseY> 22F + Fonts.font40.fontHeight &&
                scaledMouseX> baseTabWidth - 12F - Fonts.font40.getStringWidth("%ui.keybind.add%")) {
                if (scaledMouseY> baseTabHeight - 22F - Fonts.font40.fontHeight) {
