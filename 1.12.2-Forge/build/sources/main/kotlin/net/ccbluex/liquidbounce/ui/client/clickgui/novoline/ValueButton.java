package net.ccbluex.liquidbounce.ui.client.clickgui.novoline;
...
public class ValueButton {
    ...
    public void render(int mouseX, int mouseY, Window parent) {
        ...
        if (value instanceof BoolValue) {
            ...
            if (mouseX > x - 9 && mouseX < x + 87 && mouseY > y - 4 && mouseY < y + Fonts.font35.getFontHeight() + 4 && Mouse.isButtonDown(0)) {
            ...
            RenderUtils.drawRect(x + 1, y - 6, (x + 87.0f + parent.allX), y + Fonts.font35.getFontHeight() + 6, new Color(29, 29, 29).getRGB());
            RenderUtils.drawRect((float) (x + 1), y - 6, (float) (x + number + 1.0 + parent.allX), y + Fonts.font35.getFontHeight() + 6, valuebackcolor);
        ...
        if (!(value instanceof IntegerValue)) {
            Fonts.font35.drawStringWithShadow(value.getName(), x - 7 + 2, (int) y, -1);
        }
        if (value instanceof BoolValue) {
            Fonts.font35.drawStringWithShadow(name, x + Fonts.font35.getStringWidth(value.getName()) + 2, (int) y, -1);
        }
        if (value instanceof IntegerValue) {
            Fonts.font35.drawStringWithShadow(value.getName(), x - 7, (int) (y - 1), -1);
            Fonts.font35.drawStringWithShadow(name, x + Fonts.font35.getStringWidth(value.getName()) + 2, (int) (y - 1), -1);
        }
        if (value instanceof ListValue) {
            Fonts.font35.drawStringWithShadow(name, x + 90 - Fonts.font35.getStringWidth(name) + 2, (int) y, -1);
        }
    }
