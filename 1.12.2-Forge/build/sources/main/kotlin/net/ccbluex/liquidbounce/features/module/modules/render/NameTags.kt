...
@ModuleInfo(name = "NameTags", description = "Changes the scale of the nametags so you can always read them.", category = ModuleCategory.RENDER, Chinese = "名称显示")
class NameTags : Module() {
    ...
    private fun renderNameTag(entity: IEntityLivingBase, tag: String) {
        ...
        if (borderValue.get()){
            //RenderUtils.drawShadowWithCustomAlpha(-width - 2F, -2F, width + 4F, fontRenderer.fontHeight + 2F, 255f)
            RenderUtils.drawRoundedRect(-width - 2F, -2F, width + 4F, fontRenderer.fontHeight + 2F,2F, Color(0, 0, 0, 10).rgb)
