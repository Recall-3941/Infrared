...
public class FluxFont
{
    ...
    public FluxFont(final Font font, final boolean antiAlias, final int charOffset, final boolean allChar, final int yAddon) {
    ...
    public FluxFont(final Font font, final boolean antiAlias, final boolean allChar, final int yAddon) {
        this.IMAGE_WIDTH = 1024;
        this.IMAGE_HEIGHT = 1024;
        this.chars = new IntObject[2048];
        this.fontHeight = -1;
