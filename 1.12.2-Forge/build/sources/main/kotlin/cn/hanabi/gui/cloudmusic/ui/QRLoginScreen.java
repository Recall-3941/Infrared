...
//        Minecraft.getMinecraft().fontRenderer.drawString(text, res.getScaledWidth() / 2 - (Minecraft.getMinecraft().fontRenderer.getStringWidth(text) / 2), 30, 0xFFFFFFFF);
//        Minecraft.getMinecraft().fontRenderer.drawString(state, res.getScaledWidth() / 2 - (Minecraft.getMinecraft().fontRenderer.getStringWidth(state.replaceAll("\247.", "")) / 2), 50, 0xFFFFFFFF);
//
//        if (this.loginProcessThread != null) {
//            final IResourceLocation qr = WrapperImpl.INSTANCE.getClassProvider().createResourceLocation("cloudMusicCache/qrcode");
//            RenderUtils.drawImage(qr, res.getScaledWidth() / 2 - 64, 70, 128, 128);
//        }
//
