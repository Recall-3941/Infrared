...
public class GLUtils
{
    ...
    private static final WVec3 LIGHT0_POS = null;
    private static final WVec3 LIGHT1_POS = null;
    ...
    public static void enableStandardItemLighting() {
        ...
        final float n2 = 0.6f;
        final float n3 = 0.0f;
        GL11.glLight(16384, 4611, setColorBuffer(GLUtils.LIGHT0_POS.getXCoord(), GLUtils.LIGHT0_POS.getYCoord(), GLUtils.LIGHT0_POS.getZCoord(), 0.0));
        ...
        GL11.glLight(16385, 4611, setColorBuffer(GLUtils.LIGHT1_POS.getXCoord(), GLUtils.LIGHT1_POS.getYCoord(), GLUtils.LIGHT1_POS.getZCoord(), 0.0));
