...
public class AnimUtil {   //我擦 还在工作？
    ...
    public static Map<String, String> getAllSn() {
        ...
        if ("LINUX".equals(os)) {
            ...
            String cpuid = AnimUtil.getCPUSerial();
            String mainboard = AnimUtil.getMotherboardSN();
            String disk = AnimUtil.getHardDiskSN("c");
            String mac = AnimUtil.getMac();
