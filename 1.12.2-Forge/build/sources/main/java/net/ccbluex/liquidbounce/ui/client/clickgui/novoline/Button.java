...
public class Button {
    public Module cheat;
    public net.ccbluex.liquidbounce.ui.client.clickgui.novoline.Window parent;
    public int x;
    public float y;
    public int index;
    public int remander;
    ...
    public void render(int mouseX, int mouseY, int x11,int y11,int x22,int y22) {
        ...
        //GL11.glEnable(3089);
        //limitation.cut();
        hover = mouseX > x - 7 && mouseX < x + 85 && mouseY > y - 6 && mouseY < y + Fonts.font35.getFontHeight() + 4;
        RenderUtils.drawRect(x - 5, y - 5, x + 85 + parent.allX, y + Fonts.font35.getFontHeight() + 5, new Color(40, 40, 40).getRGB());
        RenderUtils.drawRect(x - 5, y - 5 - 1, x + 85 + parent.allX, y + Fonts.font35.getFontHeight() + 3 + 1,
        ...
        Fonts.font35.drawStringWithShadow(cheat.getName(), x, (int) (y - 1), -1);
        if (expand) {
