...
import net.ccbluex.liquidbounce.features.module.modules.render.DMGPutil.*;
...
@ModuleInfo(name = "DMGParticle",Chinese = "伤害粒子",description = "Display heatlh volume change value", category = ModuleCategory.RENDER)
