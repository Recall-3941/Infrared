...
public class MusicPlayerUI extends GuiScreen {
    ...
    public void drawScreen(int mouseX, int mouseY, float partialTicks) {
        ...
        if (Math.ceil(sidebarAnimation) > 1) {
            ...
            Minecraft.getMinecraft().fontRenderer.drawString("导入", (int) (newWidth - 23f), (int) (y + 6f), Color.GRAY.getRGB());

            if (textField.textString.isEmpty()) {
                Minecraft.getMinecraft().fontRenderer.drawString("输入歌单ID", (int) (newX + 8), (int) (y + 6f), Color.GRAY.getRGB());
            }
            ...
            GL11.glScissor((int) (newX + 6), (int) (y + 21), 137, 224);
            ...
            if (this.slots.size() > 10) {
                ...
                float progress = MathHelper.clamp(-this.scrollAni / -this.minY, 0, 1);
        ...
        Minecraft.getMinecraft().fontRenderer.drawString("网易云音乐", (int) (x + (width / 2) - (Minecraft.getMinecraft().fontRenderer.getStringWidth("网易云音乐") / 2f) - 2), (int) (y + 5), -1);
        ...
        if (MusicManager.INSTANCE.loadingThread != null) {
            ...
            RenderUtils.drawCircle2(x + 10 + (1.3f * MusicManager.INSTANCE.downloadProgress), y + height - 48, 3, new Color(255, 255, 255).getRGB());
            RenderUtils.drawCircle2(x + 10 + (1.3f * MusicManager.INSTANCE.downloadProgress), y + height - 48, 2, new Color(255, 50, 50, 255).getRGB());
        } else {
            RenderUtils.drawRoundedRect(x + 10, y + height - 50, x + 10 + (1.3f * progress), y + height - 46, 1.4f, Color.WHITE.getRGB());
            RenderUtils.drawCircle2(x + 10 + (1.3f * progress), y + height - 48, 3, new Color(255, 255, 255).getRGB());
            RenderUtils.drawCircle2(x + 10 + (1.3f * progress), y + height - 48, 2, new Color(50, 176, 255, 255).getRGB());
        }

        //按钮
        RenderUtils.drawCircle2(x + (width / 2), y + height - 24, 12, 0xff40444b); //播放和暂停

        if (extended) {
            Minecraft.getMinecraft().fontRenderer.drawString(" · ", (int) (x + width - 15), (int) (y + 5.5f), Color.WHITE.getRGB());
        } else {
            Minecraft.getMinecraft().fontRenderer.drawString("···", (int) (x + width - 15), (int) (y + 5.5f), Color.WHITE.getRGB());
        }

        Minecraft.getMinecraft().fontRenderer.drawString("QR", (int) (x + 5), (int) (y + 5.5f), Color.WHITE.getRGB());
        ...
        GL11.glEnable(GL11.GL_SCISSOR_TEST);
        GL11.glScissor((int) x, (int) y + (int) (height / 2 - 95), (int) width, 25);
        Minecraft.getMinecraft().fontRenderer.drawString(songName, (int) (x + (width / 2) - (Minecraft.getMinecraft().fontRenderer.getStringWidth(songName) / 2) - 1.5f), (int) (y + (height / 2 - 95)), -1);
        Minecraft.getMinecraft().fontRenderer.drawString(songArtist, (int) (x + (width / 2) - (Minecraft.getMinecraft().fontRenderer.getStringWidth(songArtist) / 2) - 1.5f), (int) (y + (height / 2 - 82)), -1);
        GL11.glDisable(GL11.GL_SCISSOR_TEST);

        if (MusicManager.INSTANCE.getMediaPlayer() != null) {

            if (MusicManager.INSTANCE.getMediaPlayer().getStatus() == Status.PLAYING) {
                Minecraft.getMinecraft().fontRenderer.drawString("| |", (int) (x + (width / 2) - (Minecraft.getMinecraft().fontRenderer.getStringWidth("K") / 2)), (int) (y + height - 25.5f), Color.WHITE.getRGB());
            } else {
                Minecraft.getMinecraft().fontRenderer.drawString("|>", (int) (x + (width / 2) - (Minecraft.getMinecraft().fontRenderer.getStringWidth("J") / 2)), (int) (y + height - 25.5f), Color.WHITE.getRGB());
            }
        ...
        Minecraft.getMinecraft().fontRenderer.drawString("←", (int) (x + width / 2 - (Minecraft.getMinecraft().fontRenderer.getStringWidth("L") / 2) - 30), (int) (y + height - 25.5f), Color.WHITE.getRGB());
        Minecraft.getMinecraft().fontRenderer.drawString("→", (int) (x + width / 2 - (Minecraft.getMinecraft().fontRenderer.getStringWidth("M") / 2) + 27.5f), (int) (y + height - 25.5f), Color.WHITE.getRGB());

        if (MusicManager.INSTANCE.repeat) {
            Minecraft.getMinecraft().fontRenderer.drawString("∞", (int) (x + width - 20), (int) (y + height - 25.5f), Color.WHITE.getRGB());
        } else {
            Minecraft.getMinecraft().fontRenderer.drawString("-", (int) (x + width - 20), (int) (y + height - 25.5f), Color.WHITE.getRGB());
        }

        if (MusicManager.INSTANCE.lyric) {
            Minecraft.getMinecraft().fontRenderer.drawString("词", (int) (x + 19), (int) (y + height - 25.5f), 0xffffffff);
        } else {
            Minecraft.getMinecraft().fontRenderer.drawString("词", (int) (x + 19), (int) (y + height - 25.5f), 0xff6b6e71);
        }

        if (MusicManager.INSTANCE.currentTrack != null) {
            if (MusicManager.INSTANCE.getArt(MusicManager.INSTANCE.currentTrack.id) != null) {
                GL11.glPushMatrix();
                final IResourceLocation icon = WrapperImpl.INSTANCE.getClassProvider().createResourceLocation(MusicManager.INSTANCE.getArt(MusicManager.INSTANCE.currentTrack.id).toString());
                RenderUtils.drawImage(icon, (int) (x + (width / 2) - 50), (int) (y + (height / 2 - 10) - 50), 100, 100);
                GL11.glPopMatrix();
            }
        }
