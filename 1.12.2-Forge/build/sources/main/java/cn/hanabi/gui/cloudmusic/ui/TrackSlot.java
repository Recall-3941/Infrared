...
public class TrackSlot {
    ...
    public void render(float a, float b, int mouseX, int mouseY) {
        ...
        Minecraft.getMinecraft().fontRenderer.drawString(track.name, (int) (x + 2), (int) (y + 1), Color.WHITE.getRGB());
        Minecraft.getMinecraft().fontRenderer.drawString(track.artists, (int) (x + 2), (int) (y + 10), Color.WHITE.getRGB());
        ...
        Minecraft.getMinecraft().fontRenderer.drawString(">", (int) (x + 125.5f), (int) (y + 5.5f), Color.WHITE.getRGB());
