...
import cn.liying.Tfont.font.Yarukon;
...
public class FontManager
{
    ...
    public static Font getIcon(int size) {
        ...
        try {
            InputStream ex = Minecraft.getMinecraft().getResourceManager().getResource(new ResourceLocation("rosalba/fonts/icon.ttf")).getInputStream();
    ...
    public static Font getFont(final String name, final int size) {
        Font font;
        try {
            final InputStream is = FontManager.class.getResourceAsStream("/assets/minecraft/loserline/fonts/" + name);
