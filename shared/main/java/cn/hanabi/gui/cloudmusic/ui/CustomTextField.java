...
public class CustomTextField {
    ...
    public void draw(float x, float y) {
        ...
        GL11.glScissor((int) this.x + 1, (int) this.y + 3, 113, 11);
        Fonts.com18.drawString(this.textString, this.x + 1.5f - this.offset, this.y + 4F, Color.GRAY.getRGB());

        if (this.isFocused) {
            float width = Fonts.com18.getStringWidth(this.textString.substring(0, selectedChar)) + 4;
            float posX = this.x + width - this.offset;
            RenderUtils.drawRect(posX - 0.5f, this.y + 5.5f, posX, this.y + 12.5f, RenderUtils.reAlpha(Color.GRAY.getRGB(), ticks / 500 % 2 == 0 ? 1f : 0));
        }
        ...
        if (this.isFocused) {
            ...
            switch (key) {
                ...
                case Keyboard.KEY_INSERT:
                    ...
                    this.selectedChar = this.textString.length();
                    width = Fonts.com18.getStringWidth( this.textString.substring(0, this.selectedChar))
                            + 2;
                ...
                case Keyboard.KEY_BACK:
                    try {
                        ...
                        if (this.textString.length() != 0) {
                            ...
                            --this.selectedChar;
                            if (Fonts.com18.getStringWidth( oldString) + 2 > 111F && this.offset > 0.0F) {
                                newTextWidth = Fonts.com18.getStringWidth( this.textString) + 2;
                                oldTextWidth = Fonts.com18.getStringWidth( oldString) + 2;
    ...
    public void charTyped(char c) {
        if (this.isFocused && ChatAllowedCharacters.isAllowedCharacter(c)) {
            ...
            if (this.selectedChar > this.textString.length()) {
                ...
                ++this.selectedChar;
                float width = Fonts.com18.getStringWidth( this.textString.substring(0, this.selectedChar)) + 2;
