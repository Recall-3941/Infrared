...
public enum MusicOverlayRenderer {
    ...
    public void renderOverlay() {
        ...
        if (MusicManager.INSTANCE.getCurrentTrack() != null && MusicManager.INSTANCE.getMediaPlayer() != null) {
            Fonts.com18.drawString( MusicManager.INSTANCE.getCurrentTrack().name + " - " + MusicManager.INSTANCE.getCurrentTrack().artists, 36f + addonX, 10 + addonY, Color.WHITE.getRGB());
            Fonts.com18.drawString( formatSeconds((int) readedSecs) + "/" + formatSeconds((int) totalSecs), 36f + addonX, 20f + addonY, 0xffffffff);
        ...
        if (MusicManager.INSTANCE.lyric) {
            {
                ...
                FontRenderer lyricFont = Minecraft.getMinecraft().fontRenderer;
                int addonYlyr = 50;
                //Lyric
        ...
        if ((MusicManager.showMsg)) {
            ...
            RenderUtils.drawRect(sr.getScaledWidth() - animation, 5, sr.getScaledWidth(), 40, RenderUtils.reAlpha(Color.BLACK.getRGB(), 0.7f));
