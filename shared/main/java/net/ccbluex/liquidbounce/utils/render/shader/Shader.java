...
public abstract class Shader extends MinecraftInstance {
    ...
    public Shader(final String fragmentShader) {
        ...
        try {
            final InputStream vertexStream = getClass().getResourceAsStream("/assets/minecraft/loserline/shader/vertex.vert");
            vertexShaderID = createShader(IOUtils.toString(vertexStream), ARBVertexShader.GL_VERTEX_SHADER_ARB);
            IOUtils.closeQuietly(vertexStream);

            final InputStream fragmentStream = getClass().getResourceAsStream("/assets/minecraft/loserline/shader/fragment/" + fragmentShader);
