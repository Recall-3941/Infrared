...
import net.ccbluex.liquidbounce.utils.TeamsUtils
...
@ModuleInfo(name = "Teams",Chinese="超市队友", description = "Prevents Killaura from attacking team mates.", category = ModuleCategory.MISC)
class Teams : Module() {
    ...
    private val namecolorValue = BoolValue("NameColor",false)
    ...
    fun isInYourTeam(entity: IEntityLivingBase): Boolean {
        ...
        if (namecolorValue.get() && !TeamsUtils.checkEnemyNameColor((mc2.player))) {
            return false;
        }
