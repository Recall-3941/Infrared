...
@ModuleInfo(name = "Regen", description = "快速恢复你的生命值",Chinese="快速回血",category = ModuleCategory.PLAYER)
class Regen : Module() {

    private val modeValue = ListValue("Mode", arrayOf("Vanilla", "Spartan", "NewSpartan","AACv4"), "Vanilla")
