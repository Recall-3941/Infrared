...
@ModuleInfo(name = "StrafeFix", description = "StrafeFix", category = ModuleCategory.MOVEMENT, Chinese = "空中移动修复")
class StrafeFix : Module() {
    ...
    fun runStrafeFixLoop(isSilent: Boolean, event: StrafeEvent) {
        ...
        var angleDiff =
            ((WMathHelper.wrapAngleTo180_float(mc.thePlayer!!.rotationYaw - yaw - 22.5f - 135.0f) + 180.0).toDouble() / (45.0).toDouble()).toInt()
