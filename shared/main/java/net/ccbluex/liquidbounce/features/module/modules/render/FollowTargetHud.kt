...
@ModuleInfo(name = "FollowTargetHud",Chinese="跟随目标显示",description="FDP", category = ModuleCategory.RENDER)
class FollowTargetHud : Module() {
    private val modeValue = ListValue("Mode", arrayOf("Juul", "Jello", "Material", "Arris", "FDP"), "Juul")
    private val fontValue = FontValue("Font", Fonts.com30)
