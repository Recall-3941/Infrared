...
//
//@ModuleInfo(name = "NewScaffold",Chinese ="新自动搭路", description = "Automatically places blocks beneath your feet.", category = ModuleCategory.WORLD, keyBind = Keyboard.KEY_I)
...
//     * Move player
//     */
//    private void move(MotionEvent2 event) {
...
//
//    @EventTarget
//    public void onMotion(final MotionEvent2 event) {
//        // XZReducer
...
//        int infoWidth = Fonts.font30.getStringWidth(info);
...
//
//            Fonts.font30.drawCenteredString(info, scaledResolution.getScaledWidth() / 2, scaledResolution.getScaledHeight() / 2 - 36, -1);
//        }
//
...
//            GlStateManager.resetColor();
//            Fonts.font30.drawCenteredString(info, scaledResolution.getScaledWidth() / 2 + 0.1F, scaledResolution.getScaledHeight() - 70, new Color(1F, 1F, 1F, 0.8F * progress).getRGB(), false);
//            GlStateManager.translate(0, 14F + (progress * 4F), 0);
//        }
//
