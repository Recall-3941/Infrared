...
import cn.liying.utils.Animation
import cn.liying.utils.DecelerateAnimation
...
open class Module : MinecraftInstance(), Listenable {
    ...
    var hovvv=false;
    var hoverOpacity = 0F
    val ani1: Animation = DecelerateAnimation(250, 1.0)
    var rectHoved = 0F
    ...
    var translateList = Translate(0F,0F);
    val moduleTranslate = Translate(0F, 0F)
    val moduleTranslate1 = Translate(0F, 0F)
    val moduleTranslate2 = Translate(0F, 0F)
    ...
    var state = false
        set(value) {
            ...
            if (!LiquidBounce.isStarting) {
                if(value) mc.soundHandler.playSound("block.stone_pressureplate.click_on", 1F)else mc.soundHandler.playSound("block.stone_pressureplate.click_off",1F)
