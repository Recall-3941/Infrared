...
@ModuleInfo(name = "Scaffold2", description = "New", category = ModuleCategory.WORLD, Chinese = "自动搭路2")
...
//    private val counterblurValue = BoolValue("CounterBlur",false)//.displayable { counterDisplayValue.get() }
...
//        if (counterblurValue.get()) {
//            RoundedUtil.drawRound((scaledResolution.scaledWidth / 2).toFloat() - 7 ,(scaledResolution.scaledHeight / 2 + 17).toFloat(),Fonts.ppr40.getStringWidth(getBlocksAmount().toString() + " Blocks").toFloat() + 15f,Fonts.ppr40.fontHeight + 8f, 5f, Color.BLACK)
//        }
//    }
    @EventTarget
...
//            RoundedUtil.drawRound((scaledResolution.scaledWidth / 2).toFloat() - 7 ,(scaledResolution.scaledHeight / 2 + 17).toFloat(),Fonts.ppr40.getStringWidth(getBlocksAmount().toString() + " Blocks").toFloat() + 15f,Fonts.ppr40.fontHeight + 8f,5f,Color(0,0,0,100))
//            Fonts.ppr40.drawString(getBlocksAmount().toString() + " Blocks",
