...
@ModuleInfo(name = "SuperKnockback", description = "Fix by JIEMO",Chinese="超级击退", category = ModuleCategory.COMBAT)
class SuperKnockback : Module() {
    private val hurtTimeValue = IntegerValue("HurtTime", 10, 0, 10)
    private val modeValue = ListValue("Mode", arrayOf("Normal", "MCYC", "ExtraPacket", "LightSense", "Packet", "HYTPacket", "Tick" ), "Normal")
