 ...
 */
class JumpEvent(var motion: Float , var sprinting :Boolean , var yaw :Float) : CancellableEvent()
...
class MotionEvent2(val eventState: EventState ,var onGround: Boolean) : Event() {
    fun isPre() : Boolean {
...
class MoveInputEvent(var forward: Float, var strafe: Float, var jump: Boolean, var sneak: Boolean,
                     var sneakSlowDownMultiplier: Double) : Event()