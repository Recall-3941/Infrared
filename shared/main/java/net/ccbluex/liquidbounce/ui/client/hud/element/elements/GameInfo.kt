...
//            fontValue.get().drawStringWithShadow("Ping:" + EntityUtils.getPing(mc.thePlayer!!).toString(), 7, this.GameInfoRows * 18 + 36, Color(textredValue.get(), textgreenValue.get(), textblueValue.get(), textblueae.get()).rgb)
...
//            Fonts.font30.drawStringWithShadow("Speed: " + MovementUtils.calculateBPS(),
