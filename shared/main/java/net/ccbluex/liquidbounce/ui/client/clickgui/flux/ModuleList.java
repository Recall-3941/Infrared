...
public class ModuleList {
    ...
    public void draw(int Sx,int Sy,int mouseX,int mouseY){
        ...
        for (Module module : LiquidBounce.moduleManager.getModuleInCategory(this.modulecategory)){
            ...
            if (module.getState()) {
                Fonts.font30.drawStringWithShadow(module.getName(), startX - 137, (int) (modulePosY + 4), new Color(255,255,255).getRGB());
            }else{
                Fonts.font30.drawStringWithShadow(module.getName(), startX - 137, (int) (modulePosY + 4), new Color(153, 153, 153).getRGB());
            }
            if (isHovered(startX-137, modulePosY+5,startX-137+Fonts.font30.getStringWidth(module.getName()),modulePosY+15,mouseX,mouseY)){
