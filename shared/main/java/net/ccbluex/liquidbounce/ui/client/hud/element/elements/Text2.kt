...
//                "ping" -> return "${EntityUtils.getPing(mc.thePlayer)}"
//            }
//        }
//
//        return when (str) {
...
//        return "XiaodaSense".substring(i,i2);
//    }
//    /**
//     * Draw element
//     */
...
//            )
//            Fonts.com14.drawString(
//                "CN", 5F + Fonts.font40.getStringWidth("XiaodaSense"), 13.0f,Color(255,255,255,220).rgb
//            )
...
//            )
//            Fonts.com14.drawString(
//                "By Paimonqwq", 5.0f, 37.0f,Color(255,255,255,220).rgb
//            )
//        }
//
